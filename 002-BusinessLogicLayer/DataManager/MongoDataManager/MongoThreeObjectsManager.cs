...
{
	public class MongoThreeObjectsManager : IThreeObjectsRepository
	{
		IPersonRepository personRepository = new MongoPersonManager();
		IStudentRepository studentRepository = new MongoStudentManager();
		ITeacherRepository teacherRepository = new MongoTeacherManager();
		IVehicleRepository vehicleRepository = new MongoVehicleManager();
		IApprovalRepository approvalRepository = new MongoApprovalManager();
