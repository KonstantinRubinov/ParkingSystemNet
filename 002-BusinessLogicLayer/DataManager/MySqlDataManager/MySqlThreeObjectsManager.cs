...
{
	public class MySqlThreeObjectsManager : IThreeObjectsRepository
	{
		IPersonRepository personRepository = new MySqlPersonManager();
		IStudentRepository studentRepository = new MySqlStudentManager();
		ITeacherRepository teacherRepository = new MySqlTeacherManager();
		IVehicleRepository vehicleRepository = new MySqlVehicleManager();
		IApprovalRepository approvalRepository = new MySqlApprovalManager();
